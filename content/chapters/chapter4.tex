...
Per quanto riguarda le operazioni sui dati in \ref{lis:generic_rust} è mostrato come usando il \textit{composition pattern} in Rust è possibile implementare il tratto \verb|Add| usato per la somma dei vettori e implementare la FMA per la moltiplicazione delle matrici. Il resto della logica rimane invariata rispetto a CUDA, con una funzione \verb|benchmark<...>| che specializza sul tipo di dato ed esegue tutte le operazioni necessarie.
...
% todo: capire se c'è altro da dire
