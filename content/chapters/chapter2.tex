...
\begin{figure}[ht]
    ...
    \caption{Generazion di uno shader SPIR-V e binding nell'applicazione Vulkan}
    \label{fig:shader}
\end{figure}
...
A questo punto il codice GLSL deve essere caricato e linkato all'applicazione Vulkan. La liberia Vulkano fornisce delle macro \ref{lis:rust_macro}, che si occupano di compilare e linkare nell'eseguibile finale lo shader in fase di compilazione dell'eseguibile Vulkan.
